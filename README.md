...
[UniProt.ws](https://www.bioconductor.org/packages/release/bioc/html/UniProt.ws.html), [dbparser](https://cran.r-project.org/web/packages/dbparser/index.html), [rBiopaxParser](https://github.com/frankkramer-lab/rBiopaxParser), [mully](https://github.com/frankkramer-lab/mully), [TCGAretriever](https://cran.r-project.org/web/packages/TCGAretriever/index.html), [stringr](https://cran.r-project.org/web/packages/stringr/), [stringi](https://cran.r-project.org/web/packages/stringi/), [svMisc](https://cran.r-project.org/web/packages/svMisc/), [uuid](https://cran.r-project.org/web/packages/uuid/), [dplyr](https://cran.r-project.org/web/packages/dplyr/), [crayon](https://cran.r-project.org/web/packages/crayon/)
