...
The function needs the following arguments: - **g** - The mully graph - **proteinList** - The list of UniProt Ids of the proteins to be added - **col** - The list of attributes associated to the UniProtKB Entries to be retrieved

***Example***

```{r, eval=FALSE}
g=mully("UniProt")
g=addUPKBLayer(g,proteinList=c("P02747","P00734","P07204"),col=c("UNIPROTKB","PROTEIN-NAMES"))
```
...
```{r, eval=FALSE}
data=loadDBXML(DrugBankFilePath)
relations=getUPKBDBRelations(data,proteinList=c("P02747","P07204"),drugList=c("DB00001","DB00006"))
```
...
The function needs the following arguments: - **proteins** - The list of UniProtKB Proteins ID to be retrieved - **col** - The list of attributes associated to the UniProtKB Entries to be retrieved
...
```{r, eval=FALSE}
getUPKBInfo(c("Q6ZS62","P14384","P40259"),c("protein_name","xref_drugbank","go","xref_reactome"))
```
...
geneList=c("hsa:122706","hsa:4221","hsa:8312")
getUPKBtoKEGG(geneList,proteinList)
```
...
```{r, eval=FALSE}
data=loadDBXML(DrugBankFilePath)
g=multipath(proteinList=c("P02747","P05164"),data=data,drugList=c("DB00001","DB00006"))
```
